...
<div class="form-group {{ $errors->has('address1') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="address1" type="textarea" id="address1" >{{ isset($address->address1) ? $address->address1 : ''}}</textarea>
    {!! $errors->first('address1', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('address2') ? 'has-error' : ''}}">
    <label for="address2" class="control-label">{{ 'Address2' }}</label>
    <textarea class="form-control" rows="5" name="address2" type="textarea" id="address2" >{{ isset($address->address2) ? $address->address2 : ''}}</textarea>
...
<div class="form-group {{ $errors->has('zipcode') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="zipcode" type="text" id="zipcode" value="{{ isset($address->zipcode) ? $address->zipcode : ''}}" >
